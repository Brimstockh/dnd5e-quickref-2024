(function () {
  ...
  function renderCard(item) {
    ...
    var badges = [rarityLabels[item.rarity] || item.rarity, typeLabels[item.type] || item.typeLabel || item.type, item.requiresAttunement ? "Harmonisation" : "Sans harmonisation"];
