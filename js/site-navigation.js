...
export const SITE_SECTIONS = Object.freeze([
    section({
        ...
        groups: [
            { id: "reference", label: "Référence de jeu" },
            { id: "play", label: "Jeu à la table" },
        ...
        links: [
            ...
            entry({ id: "quickref", label: "Référence rapide", url: "quickref.html", description: "Actions, conditions et environnement", group: "reference", icon: "quick-reference", category: "Règle", contentId: "page-reference-rapide" }),
            entry({ id: "rules", label: "Règles du jeu", url: "rules-2024.html", description: "Principes généraux 2024", group: "reference", icon: "rules", category: "Règle", contentId: "page-regles-du-jeu" }),
            entry({ id: "combat", label: "Combat", url: "combat-2024.html", description: "Initiative, attaques et dégâts", group: "play", icon: "combat", category: "Règle", contentId: "page-combat" }),
            entry({ id: "mastery", label: "Maîtrises", url: "mastery-2024.html", description: "Maîtrises d’armes et actions", group: "play", icon: "mastery", category: "Règle", contentId: "page-maitrises-d-armes" }),
            entry({ id: "glossary", label: "Glossaire", url: "glossaire.html", description: "Termes et états de jeu", group: "landmarks", icon: "glossary", category: "Glossaire", contentId: "page-glossaire" }),
        ],
    }),
    section({
        id: "compendium",
    ...
    section({
        ...
        groups: [
            { id: "faerun", label: "Faerûn" },
            { id: "multiverse", label: "Multivers" },
            { id: "landmarks", label: "Repères" },
        ],
        links: [
            ...
            entry({ id: "faerun", label: "Faerûn / Royaumes Oubliés", url: "faerun.html", description: "Explorer Faerûn", group: "faerun", icon: "faerun", category: "Univers" }),
            entry({ id: "lore", label: "Lore / index du multivers", url: "lore.html", description: "Index transversal du multivers", group: "multiverse", icon: "planes", category: "Lore" }),
            entry({ id: "history", label: "Histoire", url: "histoire-royaumes.html", description: "Chronologie du monde", group: "landmarks", icon: "history", category: "Univers" }),
            entry({ id: "gods", label: "Divinités", url: "divinites.html", description: "Panthéon de Faerûn", group: "faerun", icon: "gods", category: "Univers" }),
            entry({ id: "factions", label: "Factions", url: "groupes-royaumes.html", description: "Groupes influents", group: "faerun", icon: "factions", category: "Univers" }),
            entry({ id: "people", label: "Personnages importants", url: "personnages-royaumes.html", description: "Figures importantes", group: "faerun", icon: "characters", category: "Univers" }),
            entry({ id: "planes", label: "Plans d’existence", url: "plans-existence.html", description: "Les autres réalités", group: "multiverse", icon: "planes", category: "Univers" }),
        ],
    }),
    section({
        id: "table",
        ...
        groups: [
            ...
            { id: "tools", label: "Outils de session" },
        ],
        links: [
            ...
            entry({ id: "personal", label: "Espace personnel", url: "espace-personnel.html", description: "Bibliothèque, notes et profils", group: "campaign", icon: "characters", category: "Espace personnel" }),
            entry({ id: "characters", label: "Personnages sauvegardés", url: "html/characters.html", description: "Consulter les personnages", group: "characters", icon: "characters", category: "Personnage", matches: ["html/character.html", "html/character-profile.html"] }),
            entry({ id: "campaign-rules", label: "Règles de campagne", url: "regles-campagne.html", description: "Décisions propres à notre table", group: "campaign", icon: "rules", category: "Règle de campagne" }),
            entry({ id: "dice-stats", label: "Statistiques de dés", url: "dice-stats.html", description: "Probabilités et distributions des jets de dés", group: "tools", icon: "dice", category: "Outil" }),
        ],
    }),
]);
